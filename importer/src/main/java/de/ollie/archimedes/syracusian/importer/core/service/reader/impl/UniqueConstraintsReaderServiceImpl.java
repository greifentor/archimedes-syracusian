...
public class UniqueConstraintsReaderServiceImpl
	...
	@Override
	public Set<UniqueConstraintMDO> read(String schemeName, String tableName, Connection connection) {
		...
		return accessor.getUniqueConstraints(schemeName, tableName, connection);
	}
}
